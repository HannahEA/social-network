...
func CreateDatabase() {
	...
	// comments table
	_, err4 := Database.Exec(`CREATE TABLE IF NOT EXISTS "Comments" ( 
	...
	// Notifications table
	_, err5 := Database.Exec(`CREATE TABLE IF NOT EXISTS "Notifications" ( 
	...
	// Chats table
	_, err6 := Database.Exec(`CREATE TABLE IF NOT EXISTS "Chats" ( 
	...
	_, err7 := Database.Exec(`CREATE TABLE IF NOT EXISTS "MessageHistory" ( 
	...
	_, err8 := Database.Exec(`CREATE TABLE IF NOT EXISTS "Followers" (
		"userID" INTEGER, 
	...
	_, err9 := Database.Exec(`CREATE TABLE IF NOT EXISTS Profile (
		"userID" INTEGER,
		"postID" INTEGER,
		"followerID" INTEGER,

...
const handleGroupInvite = (e) => {
  ...
  return (
    <div className="modal-overlay" onClick={handleOverlayClick} style={{zIndex:988}}>
     <div className="dark:bg-gray-600 w-3/4 bg-gray-100 p-4 m-6 position-relative overflow-auto max-h-screen min-h-min min-w-fit" style={{zIndex:988}}> 

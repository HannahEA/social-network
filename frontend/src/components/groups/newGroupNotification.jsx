...
function NewGroupNotification ( props ) {
  ...
  const handleNo = () => {
    ...
    //return isVisible ? (
    return (
    <div className="notification-item text-gray-600 font-normal text-sm mb-1.5 dark:text-gray-400 bg-[#9dd6f7]" style={{zIndex:998, visibility:`${props.grNotifVisible ? 'visible' : 'hidden'}`}}>
